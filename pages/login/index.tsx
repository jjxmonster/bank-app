      ...
      <div className='min-h-screen flex bg-gray'>
         <div className='w-auto flex'>
            ...
            >
               ...
               <div className='mt-7 mb-6 md:mb-0 hover:opacity-80'>
                  <button
                     className='w-full bg-purple-light border-rounded text-white font-medium p-3'
                     type='submit'
                  >
                     SUBMIT
                  </button>
                  {error && (
                     <p className='text-red-500 mt-3 text-md italic'>{error}</p>
                  )}
               </div>
            </form>
         </div>
